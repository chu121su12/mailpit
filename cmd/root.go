...
func init() {
	...
	rootCmd.Flags().StringVar(&config.UIUserMailHeader, "ui-user-mail-header", config.UIUserMailHeader, "Header to obtain mailbox TO: filter")
...
func initConfigFromEnv() {
	...
	config.UIUserMailHeader = os.Getenv("MP_UI_USER_MAIL_HEADER")
